...
class ConnectionManager:
    def __init__(self) -> None:
        ...
        self._driver_last: Dict[int, dict] = {}
    ...
    def set_driver_location(self, driver_id: int, data: dict) -> None:
        self._driver_last[driver_id] = data

    def get_driver_locations(self) -> list[dict]:
        return list(self._driver_last.values())
