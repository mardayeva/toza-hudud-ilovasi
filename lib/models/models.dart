...
class FoydalanuvchiMaInfo {
  final String fish;       // F.I.Sh
  final String pinfl;      // Shaxsiy identifikatsiya raqami
  final String tugilganSana;
  final String manzil;
  final bool tasdiqlangan;

  const FoydalanuvchiMaInfo({
    required this.fish,
    required this.pinfl,
...
class QarzdorlikInfo {
  final String hisobRaqam;
  final double jarimamiqdori;
  final double tolanganMiqdor;
  final double qolganQarz;
  final DateTime oxirgiTolov;
  final List<QarzdorlikOy> oylarRoyxati;

  const QarzdorlikInfo({
    required this.hisobRaqam,
    required this.jarimamiqdori,
    required this.tolanganMiqdor,
    required this.qolganQarz,
    required this.oxirgiTolov,
    required this.oylarRoyxati,
  });

  bool get qarzdorMi => qolganQarz > 0;
}

class QarzdorlikOy {
  final String oy;      // "2024-03"
  final double summa;
  final bool tolangan;
